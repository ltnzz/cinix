...
import { Clapperboard, Clock, MapPin, Ticket, Trash2, ArrowLeft, User, QrCode, CalendarDays } from "lucide-react"; 
...
if (loading && !user) {
    return (
        <div className="min-h-screen bg-[#6a8e7f] flex items-center justify-center flex-col gap-4">
            <div className="w-8 h-8 border-4 border-[#fff9e6] border-t-transparent rounded-full animate-spin"></div>
            <div className="text-[#fff9e6] font-bold text-lg animate-pulse">
                Memuat tiket...
            </div>
        </div>
    );
    ...
    <main className="container mx-auto px-4 md:px-8 py-10 max-w-4xl">
        ...
        <div className="space-y-6">
            {tickets.length > 0 ? (
                ...
                <div className="text-center py-20 bg-white/10 rounded-3xl border-2 border-dashed border-white/30 text-white/60 flex flex-col items-center">
